...
class UserPickView;
class User;
class UserInfo3 : public UIComponent
{
private:
	int					  m_money;
...
public:
	UserInfo3(int _x, int _y, int _width, int _height, bool _focused, ID2D1SolidColorBrush* _brush, IDWriteTextFormat* _textForamt, int _playerNumber);
	virtual ~UserInfo3();
