...
#include "Bitmap.h"
#include "ResourceManager.h"
UserInfo3::UserInfo3(int _x, int _y, int _width, int _height, bool _focused, ID2D1SolidColorBrush* _brush, IDWriteTextFormat* _textForamt, int _playerNumber) : UIComponent(_x, _y, _width, _height, _focused), m_blackBrush(_brush), m_textformat(_textForamt), m_playerNumber(_playerNumber)
{
    Init();
}
...
bool UserInfo3::ISFocus(int _x, int _y)
{
    return false;
}

void UserInfo3::Init(User& _dt)
{
...
void UserInfo3::SetMoney(int _money)
{
